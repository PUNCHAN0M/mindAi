    ...
    <div className={`card-ListTeacher ${isExpanded ? "expanded" : ""}`}>
      <div className="card-container">
        ...
        <div className="button-card-ListTeacher">
          <div className="icon-button" style={{ opacity: recommand ? 1 : 0 }}>
            <div className="SvgLike">
              <SvgLike />
            </div>
          </div>
              ...
              <div className="gmail-contact">
                <p>
                  ...
                  >
                    ...
                    />
                    <path
                      d="M3.5 13.75V8.1177C3.5 8.0062 3.61735 7.93367 3.71708 7.98354L9.15836 10.7042C10.0029 11.1265 10.9971 11.1265 11.8416 10.7042L17.2829 7.98354C17.3827 7.93367 17.5 8.0062 17.5 8.11771V13.75C17.5 14.8546 16.6046 15.75 15.5 15.75H5.5C4.39543 15.75 3.5 14.8546 3.5 13.75Z"
                      fill="#2C2C2C"
                    />
                  </svg>
                </p>
